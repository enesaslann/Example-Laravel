				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<p class="card-title-desc">Blogunuz güncelle.</p>
							<div class="row">
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.blog.update', $blog->id ) }}" method="post" enctype="multipart/form-data">
										...
										<div class="form-group ">
											...
											<div class="col-lg-3">
												<input id="input-file-now" class="dropify" name="cover_image" type="file" id="example-email-input1" required="true" data-default-file="{{ $blog->cover_image }}">
											</div>
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Fotoğraf Bir <span style="color: red;">*</span></label>
											<div class="col-lg-3">
												<input id="input-file-now" class="dropify" name="image" type="file" id="example-email-input1" required="true" data-default-file="{{ $blog->image }}">
											</div>
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Fotoğraf İki <span style="color: red;">*</span></label>
											<div class="col-lg-3">
												<input id="input-file-now" class="dropify" name="image_two" type="file" id="example-email-input1" required="true" data-default-file="{{ $blog->imagetwo }}">
											</div>
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Başlık <span style="color: red;">*</span></label>
											<input class="form-control" name="title" type="text" id="example-email-input1" placeholder="Blog başlığını giriniz" required="true" value="{{ old('title', $blog->title ) }}">
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Başlık Alt satır</label>
											<input class="form-control" name="title_two" type="text" id="example-email-input1" placeholder="Blog alt başlığını giriniz" value="{{ old('title_two', $blog->title_two ) }}">
										</div>
										<div class="form-group" id="example-email-input1">
											...
											<input class="form-control" name="brief_description" type="text" id="example-email-input1" placeholder="Blog kısa açıklama giriniz" maxlength="150" value="{{ old('brief_description', $blog->brief_description) }}">
										</div>
										<div class="form-group" id="example-email-input1">
										...
										<div class="form-group" id="example-email-input1">
											...
											<textarea id="elm2" name="description_two">{{ old('description_two', $blog->description_two) }}</textarea>
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama üç</label>
											<textarea id="elm3" name="description_three">{{ old('description_three', $blog->description_three) }}</textarea>
										</div>
