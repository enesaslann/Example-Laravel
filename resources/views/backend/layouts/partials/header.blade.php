<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('admin.index') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('assets/img/dark/logo.svg')}}" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('assets/img/dark/logo.svg')}}" alt="" height="50" >
                    </span>
        ...
        <div class="dropdown d-inline-block">
            <a href="/" target="_blank" class="btn btn-light   btn-rounded ml-1"><i class="fas fa-eye"></i></a>
            <!--
            <div class="dropdown d-inline-block">
...
-->
<a href="{{ route('admin.logout') }}">  <span class="d-xl-inline-block ml-1 btn btn-warning">Çıkış</span></a>
</div>
