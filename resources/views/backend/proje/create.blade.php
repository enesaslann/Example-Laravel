						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.proje.create') }}" method="post"  enctype="multipart/form-data">
										@csrf 
										<div class="form-group">
											<label for="example-email-input1" class="col-form-label pt-0">Kapak Görseli </label>
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="cover_image" type="file" id="example-email-input1">
											</div>
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama </label>
											<input class="form-control" name="title_description" type="text" id="example-email-input1" placeholder="Açıklama"  value="{{ old('title_description') }}">
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Proje Kategorisi </label>
											<input class="form-control" name="category" type="text" id="example-email-input1" placeholder="Proje"  value="{{ old('category') }}">
										</div>

										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Kısa Tanıtım</label>
											<input class="form-control" name="brief" type="text" id="example-email-input1" placeholder="Proje"  value="{{ old('brief') }}">
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Başlık Bir </label>
											<input class="form-control" name="one_title" type="text" id="example-email-input1" placeholder="Başlık"   value="{{ old('one_title') }}">
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama</label>
											<textarea id="elm1" name="one_description">{{ old('one_description') }}</textarea>
										</div>

										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Başlık İki </label>
											<input class="form-control" name="two_title" type="text" id="example-email-input1" placeholder="Başlık"  value="{{ old('two_title') }}">
										</div> 
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama İki </label>
											<textarea id="elm2" name="two_description">{{ old('two_description') }}</textarea>
										</div>	
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama Üç </label>
											<textarea id="elm3" name="three_description">{{ old('three_desctiption') }}</textarea>
										</div>	

										<div class="form-group">
											<label for="example-email-input1" class="col-form-label pt-0">Fotograf</label>
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="image" type="file" id="example-email-input1" >
											</div>
										</div>
										<div class="form-group">
											<label for="example-email-input1" class="col-form-label pt-0">Fotograf 2</label>
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="image_two" type="file" id="example-email-input1" >
											</div>
										</div>
										<div class="form-group">
											<label for="example-email-input1" class="col-form-label pt-0">Fotograf 3</label>
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="image_three" type="file" id="example-email-input1" >
											</div>
										</div>
										<div class="form-group">
											<label for="example-email-input1" class="col-form-label pt-0">Fotograf 4</label>
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="image_four" type="file" id="example-email-input1" >
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-12">
												<input id="input-file-now" class="dropify" name="image_five" type="file" id="example-email-input1" >
											</div>
										</div>
