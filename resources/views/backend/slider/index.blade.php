		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin.slider.create.index') }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Slider</span></span></a>
									...
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="{{ route('admin.slider.update.index', $entry->id) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>  
													@if($entry->status == 0)
													<a href="{{ route('admin.slider.status.active', $entry->id) }}" class="btn btn-danger waves-effect waves-light">Aktif Yap</a>
													@else
													<a href="{{ route('admin.slider.status.passive', $entry->id) }}" class="btn btn-success waves-effect waves-light">Pasif Yap</a>
													@endif
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.slider.delete', $entry->id) }}" method="get">
																		@csrf
