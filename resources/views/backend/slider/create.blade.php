								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.slider.create' ) }}" method="post"  enctype="multipart/form-data">
										...
										<div class="form-group ">
											...
											<div class="col-lg-3">
												<input  id="input-file-now" required class="dropify" name="image" type="file">
											</div>
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Başlık <span style="color: red;">*</span></label>
											<input class="form-control" name="title" type="text" id="example-email-input1" placeholder="Slider başlığını giriniz" required="true" value="{{ old('title') }}">
										</div>
										<div class="form-group" id="example-email-input1">
											...
											<input class="form-control" name="description" type="text" id="example-email-input1" placeholder="Slider açıklma giriniz" required="true" value="{{ old('description') }}">
										</div>	
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Link<span style="color: red;">*</span></label>
											<input class="form-control" name="link" type="text" id="example-email-input1" placeholder="Slider açıklma giriniz" required="true" value="{{ old('link') }}">
										</div>
