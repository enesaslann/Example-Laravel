					...
					<div class="card mb-0 shadow-none">
						<div class="card-body">
							...
							<h3 class="text-center m-0">
								<a href="/" class="logo logo-admin"><img src="{{asset('assets/img/dark/logo.svg')}}" height="100" alt="azra yeşiltaş" class="my-3"></a>
							</h3>

							<div class="px-2 mt-2">
								<!--<h4 class="text-muted font-size-18 mb-2 text-center">Mimarlık</h4>-->
				...
				<div class="col-lg-9 p-0 vh-100  d-flex justify-content-center">
					<div class="accountbg d-flex align-items-center"> 
						<div class="account-title text-center text-white">
							<h1  style="color:#f7f7f5;"> Azra Yeşiltaş </h1>
