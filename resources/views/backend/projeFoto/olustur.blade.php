			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18"><b>{{ $proje['title'] }}</b> Proje İçin Görsel Oluştur</h4>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin.proje.image', $proje['id']) }}"><span class="btn btn-purple btn btn-xl inputTwo" style="margin-bottom: 20px"><span class="dripicons-arrow-thin-left"> Önceki Sayfa</span></span></a>
							<h4 class="card-title">Proje Görseli Oluştur</h4>
							<p class="card-title-desc">Proje görseli oluşturunuz.</p>
							<div class="row">
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.proje.image.create', $proje['id']) }}" method="post" enctype="multipart/form-data">
										@csrf
