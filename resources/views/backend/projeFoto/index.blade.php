			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18"><b>{{ $proje['title'] }}</b> Proje Görselleri</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="{{ route('admin.proje.image.create.index', $proje['id']) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Proje Görseli</span></span></a>
							<a href="{{ route('admin.proje.image.order.index', $proje['id']) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Sırala</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Proje Görselleri</h5>
							<p class="card-title-desc">
								Proje görsellerine bu sayfadan ulaşabilirsiniz.
							</p>
								...
								<div class="table-responsive">
									<table class="table mb-0" id="datatable2">
										...
										<tbody>
											...
											<tr>
												<td><img src="{{ $entry->image }}" height="200"></td>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.proje.image.delete', $entry->id) }}" method="get">
																		@csrf
