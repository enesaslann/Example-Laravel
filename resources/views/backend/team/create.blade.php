								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.team.create') }}" method="post"  enctype="multipart/form-data">
										...
										<div class="form-group" id="example-email-input1">
											...
											<input class="form-control" name="name" type="text" id="example-email-input1" placeholder="Çalışan isim" required="true" value="{{ old('name') }}">
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Görevi <span style="color: red;">*</span></label>
											<input class="form-control" name="title" type="text" id="example-email-input1" placeholder="Görevini giriniz" required="true" value="{{ old('title') }}">
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Mesaj<span style="color: red;">*</span></label>
											<input class="form-control" name="description" type="text" id="example-email-input1" placeholder="Mesajını giriniz" required="true" value="{{ old('description') }}">
										</div>	
